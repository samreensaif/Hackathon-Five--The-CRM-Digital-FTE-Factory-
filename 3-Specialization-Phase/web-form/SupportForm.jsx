 ...
 *
 * Customer-facing support form that submits inquiries
 * to the Customer Success Digital FTE API.
 *
 * Usage:
...
const API_URL = window.FTE_API_URL || "/api/support/submit";
...
function SupportForm({ apiUrl }) {
  const endpoint = apiUrl || API_URL;
